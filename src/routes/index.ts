...
import vtkDistanceWidget from '../views/vtkDistanceWidget.vue'
import PolyLineWidget from '../views/PolyLineWidget.vue'
export const routes = [
  {
    path: '/',
    component: World,
  ...
  {
    path: '/vtkDistanceWidget',
    name: 'vtkDistanceWidget',
    component: vtkDistanceWidget,
    meta: {
      title: '测量组件',
      icon: 'UserFilled',
    },
